...
// data.forEach((card) => {
//   cardList.innerHTML += `  <li class="card-item flex-center-column">
//   <div class="img-container">
//     <img class="card-image" data-index-number=${card.id} src=${card.image} alt="Portfolio im">
//   </div>
...
//         <img class= "list-item-btn"src="img/botton.png" alt="btn">
